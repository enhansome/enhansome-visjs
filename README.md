...
* [vis-network](https://github.com/visjs/vis-network) ⭐ 3,615 | 🐛 346 | 🌐 JavaScript | 📅 2026-08-21 - Display dynamic, automatically organised, customizable network views.
* [vis-timeline](https://github.com/visjs/vis-timeline) ⭐ 2,548 | 🐛 301 | 🌐 JavaScript | 📅 2026-08-22 - Create a fully customizable, interactive timelines and 2d-graphs with items and ranges.
* [vis-graph3d](https://github.com/visjs/vis-graph3d) ⭐ 354 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-22 - Create interactive, animated 3d graphs. Surfaces, lines, dots and block styling out of the box.
* [vis-data](https://github.com/visjs/vis-data) ⭐ 119 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-22 - Manage unstructured data using DataSet. Add, update, and remove data, and listen for changes in the data.

### vis.js based libraries

#### Add-Ons

* [timeline-arrows](https://github.com/javdome/timeline-arrows) ⭐ 52 | 🐛 1 | 🌐 JavaScript | 📅 2025-09-27 - Class to easily draw lines to connect items in the vis Timeline module.
...
* [react-graph-vis](https://github.com/crubier/react-graph-vis) ⭐ 992 | 🐛 60 | 🌐 JavaScript | 📅 2023-10-12 - A react component to render NETWORK graphs.
...
* [angular-visjs](https://github.com/visjs/angular-visjs) ⭐ 132 | 🐛 34 | 🌐 JavaScript | 📅 2023-12-15 - AngularJS directive module for vis.js components.

#### Angular

* [ngx-vis](https://github.com/visjs/ngx-vis) ⭐ 73 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-21 - An angular 5+ vis.js project.
...
* [neovis.js](https://github.com/neo4j-contrib/neovis.js) ⭐ 1,788 | 🐛 59 | 🌐 TypeScript | 📅 2023-10-19 - Graph visualizations powered by vis.js with data from Neo4j.
...
* [Ruimdetijd/timeline](https://github.com/Ruimdetijd/timeline) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2023-08-24 - Slime timeline component
...
<https://github.com/emsk/skyebridge> ⭐ 11 | 🐛 7 | 🌐 JavaScript | 📅 2023-01-07
